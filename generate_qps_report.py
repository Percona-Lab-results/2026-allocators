...
<body>
    <div class="container">
        ...
        <div class="controls">
            <h3>RSS Graph Controls</h3>
            <div class="checkbox-grid" id="rssCheckboxGrid">
                <!-- Checkboxes will be generated here -->
            </div>
            <button id="rssZoomButton" class="zoom-button">Zoom In (Start at 160k MB)</button>
    ...
    <script>
        ...
        // Reset zoom button for QPS chart
        const resetZoomButton = document.getElementById('resetZoomButton');
        resetZoomButton.addEventListener('click', function() {{
            qpsChart.resetZoom();
            // Also reset the Y-axis zoom
            qpsChart.options.scales.y.min = 0;
            qpsChart.options.scales.y.beginAtZero = true;
            zoomButton.textContent = 'Zoom In (Start at 40k)';
            isZoomedIn = false;
